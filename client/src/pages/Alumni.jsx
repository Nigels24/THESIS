    ...
    <div className="flex">
      ...
      <div className="basis-[88%] border h-[100vh] overflow-scroll">
        ...
        <div className="flex-grow bg-gray-300 p-2 rounded-md container overflow-x-auto h-full sm:w-auto">
          ...
          <div className="container mx-auto p-2 overflow-x-auto max-w-full sm:w-auto">
            <table className="min-w-full table-auto">
              ...
              <tbody className="bg-white">
                {alumnisToDisplay.map((alumni, index) => (
                  <tr
                    key={index}
                    ...
                    <td className="px-2 py-2 cursor-pointer">
                      ...
                      {selectedAlumni && (
                        <div className="fixed inset-0 flex items-center justify-center z-10">
                          <div className="bg-white w-full sm:w-2/3 p-2 rounded shadow-lg z-20">
